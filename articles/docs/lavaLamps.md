...
Capture an image of the Lava Lamps Wall -->  Pixel Data Extraction --> Whitening (additional processing of image pixels and colours) ---> Hashing / Randomising stream of bytes --> 
